...
INSERT INTO movies (name, release_year, rating, fee, studio_id) VALUES
...
INSERT INTO actors (first_name, second_name, birthday) VALUES
    ...
    ('Vin', 'Diesel', '1958-10-16'),
    ('Nicolas', 'Cage', '1950-10-16'),
    ('Robert', 'Downey Jr.', '1965-10-16'),
    ('Margot', 'Robbie', '1960-12-03'),
...
WITH relations AS (
    SELECT * FROM (
        VALUES ('Morgan Freeman', 'Movie 1'),
               ...
               ('Vin Diesel', 'Movie 5'),
               ('Vin Diesel', 'Movie 7'),
               ('Nicolas Cage', 'Movie 2'),
               ('Nicolas Cage', 'Movie 4'),
               ('Nicolas Cage', 'Movie 6'),
               ('Robert Downey Jr.', 'Movie 4'),
               ('Robert Downey Jr.', 'Movie 6'),
               ('Robert Downey Jr.', 'Movie 7'),
               ('Margot Robbie', 'Movie 2'),
               ('Margot Robbie', 'Movie 7'),
               ('Jim Carrey', 'Movie 1'),
               ('Jim Carrey', 'Movie 3')
