...
import (
	"flag"
	"fmt"
	"go_course_thinknetika/12_search_engine/pkg/crawler/spider"
	"go_course_thinknetika/12_search_engine/pkg/index"
	"go_course_thinknetika/12_search_engine/pkg/storage"
	"log"
	"os"
)
